...
function updateFilters() {
    ...
    let changedElement = d3.select().property("value");
    ...
    // 5. If filter value was entered, add that filterId and value to filters list. Otherwise, clear that filter from the filters object
    if (elementValue) {
  ...
  function filterTable() {
    ...
    if(filters) {
      filteredData = filteredData.filter(row => row.string === filters)
    }
